...
extension NSFetchRequest {
    ...
    func optimizeForLargeDataset() {
        ...
        propertiesToFetch = nil // Set specific properties if needed
    }
}
...
enum MemoryManager {
    ...
    /// - Returns: The result of the block
    static func withAutoreleasePool<T>(_ block: () async throws -> T) async rethrows -> T {
...
enum BackgroundTaskManager {
    ...
    static func execute(qos: DispatchQoS.QoSClass = .userInitiated, _ task: @escaping () async throws -> Void) {
